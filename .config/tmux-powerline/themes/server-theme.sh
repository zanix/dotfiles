...
if [ -z "$TMUX_POWERLINE_WINDOW_STATUS_FORMAT" ]; then
    ...
    "#{?window_activity_flag,#[fg=colour172 bg=colour0],#[$(format regular)]}"
		" #I "
		"$TMUX_POWERLINE_SEPARATOR_RIGHT_THIN"
		" #W "
	)
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"mode_indicator default_bg_color 165"
		"tmux_session_info default_bg_color 148"
		"hostname default_bg_color 33"
		# "pwd default_bg_color 75"
		# "vcs_branch default_bg_color 29"
		# "vcs_compare default_bg_color 60"
		# "vcs_staged default_bg_color 64"
		# "vcs_modified default_bg_color 9"
		# "vcs_others default_bg_color 245"
	)
fi
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		# "cpu default_bg_color 136"
		"load default_bg_color 167 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "tmux_mem_cpu_load default_bg_color 136"
		# "battery default_bg_color 127"
		# "air default_bg_color ${TMUX_POWERLINE_SEG_AIR_COLOR}"
		# "weather default_bg_color 37"
		# "rainbarf default_bg_color ${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR}"
		# "xkb_layout default_bg_color 117"
		# "date_day default_bg_color 74"
		# "date default_bg_color 74"
    "time default_bg_color 74 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}"
		# "utc_time default_bg_color 74"
	)
fi
